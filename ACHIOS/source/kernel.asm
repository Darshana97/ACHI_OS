;ACHIOS --- The Darshana's Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE ACHIOS_VER '1.0.0'	 ;OS version number
	%DEFINE ACHIOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to Darshana OS****************************', 0
	os_version_msg		db 'Version ', ACHIOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', ACHIOS_VER, 0

	dialog_string_1		db 'Welcome to Darshana Operating System', 0
