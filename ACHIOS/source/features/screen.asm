...
.one_button:
	mov bl, 11000000b		; Black on white
	mov dh, 14
	mov dl, 35
	mov si, 8
	mov di, 15
...
.two_button:
	mov bl, 11100000b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
...
.two_button_wait:
	...
	mov bl, 01111111b		; White on red for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 10100000b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
	...
	mov bl, 11100000b		; White on red for cancel button
	mov dh, 14
	mov dl, 43
	mov si, 8
	mov di, 15
...
.noright:
	...
	.ok_button_string	db 'HDD', 0
	.cancel_button_string	db 'Exit', 0
	.ok_button_noselect	db 'HDD', 0
